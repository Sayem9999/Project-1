...
PROMPT = """You are the Cutter Agent for edit.ai, a professional automated editing service.
...
async def run(payload: dict) -> dict:
    return await run_agent_prompt(PROMPT, payload, model="gpt-4.1" if "cutter" in ["director","qc"] else "gpt-4o-mini")
