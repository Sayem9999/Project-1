      ...
      <div className="glass-panel w-full max-w-md p-8 rounded-2xl relative overflow-hidden">
        ...
        <div className="space-y-3 mb-6">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-lg bg-white text-gray-800 font-medium hover:bg-gray-100 transition-all disabled:opacity-50"
          >
            {oauthLoading === 'google' ? (
          ...
          <button
            ...
            disabled={oauthLoading !== null}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-lg bg-[#24292e] text-white font-medium hover:bg-[#2f363d] transition-all disabled:opacity-50"
          >
            {oauthLoading === 'github' ? (
              <div className="w-5 h-5 border-2 border-gray-400 border-t-transparent rounded-full animate-spin"></div>
            ) : (
