            ...
            <div className="container mx-auto px-6 py-16">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
                    ...
                    <div className="col-span-2 md:col-span-1">
                        ...
                        <p className="text-sm text-gray-500 mb-6 max-w-xs">
                            AI-powered video editing that transforms your raw footage into cinematic content.
                        </p>
                        ...
                        <div className="flex items-center gap-3">
                            {[
                                ...
                                <a
                                    key={i}
                                    href="#"
                                    className="w-9 h-9 rounded-lg bg-white/5 flex items-center justify-center text-gray-400 hover:bg-cyan-500/20 hover:text-cyan-400 transition-all"
                ...
                <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-sm text-gray-500">
                        © {currentYear} Proedit.ai. All rights reserved.
                    </p>
